...
const EditAddress: React.FC<EditAddressProps> = ({
  ...
  return (
    <>
      <div
        className={clx(
          "border rounded-sm p-5 min-h-[220px] h-full w-full flex flex-col justify-between transition-colors",
          {
      ...
      <Modal isOpen={state} close={close}>
        ...
        <form action={formAction}>
          <Modal.Body>
            ...
            {formState.error && (
              <div className="text-ui-fg-error text-small-regular py-2">
                {formState.error}
              </div>
            )}
          </Modal.Body>
