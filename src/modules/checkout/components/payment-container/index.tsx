...
const PaymentContainer: React.FC<PaymentContainerProps> = ({
  ...
  return (
    <RadioGroup.Option
      ...
      disabled={disabled}
      className={clx(
        "flex flex-col gap-y-2 text-small-regular text-ui-fg-base cursor-pointer py-4 border rounded-rounded px-8 mb-2 hover:shadow-borders-interactive-with-active ",
        {
